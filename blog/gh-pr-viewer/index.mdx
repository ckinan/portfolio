...
As a reviewer, I have to open pull requests regularly to do my review. Meaning, more than likely I have to visit [https://github.com/pulls](https://github.com/pulls) frequently to see whichh PRs I have in my queue.
...
- Goal #2: How to use its "develop mode". Ref: [https://www.netlify.com/products/dev/](https://www.netlify.com/products/dev/)
...
- Method #1: Authorizing OAuth Apps. Ref: [https://developer.github.com/apps/building-oauth-apps/authorizing-oauth-apps/](https://developer.github.com/apps/building-oauth-apps/authorizing-oauth-apps/)
- Method #2: Store a Personal Access Token as Environment Variable. (Only meant to be used locally)

~~I believe this is the main reason I can't get this project deployed in the cloud, because I can't figure this thing out yet...~~ . UPDATE: Deployed on Netlify: [https://gh-pr-viewer.netlify.app/](https://gh-pr-viewer.netlify.app/)
...
- Repo: [https://github.com/ckinan/gh-pr-viewer](https://github.com/ckinan/gh-pr-viewer)
- Netlify instance: [https://gh-pr-viewer.netlify.app/](https://gh-pr-viewer.netlify.app/)
