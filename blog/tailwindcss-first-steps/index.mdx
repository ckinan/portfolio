---
title: Tailwind CSS - First Steps
date: 2020-05-17
slug: tailwind-css-first-steps
---
...
3. Go to Tailwind CSS docs and search for the CSS property. Link: [https://tailwindcss.com/docs/background-color](https://tailwindcss.com/docs/background-color) . For the Green Background, the Tailwind CSS "equivalent class" should be `class="bg-green-500"`
...
Example in codepen: [https://codepen.io/ckinan/pen/JjYePyW](https://codepen.io/ckinan/pen/JjYePyW)
